...
from ecdsa.util import sigdecode_der as der_decode_signature
import base64
...
def create_cert(c1_c2,  cid):
    ...
    cid_base64 = base64.urlsafe_b64encode(cid).decode('utf-8').replace('=', '')
    ...
    filename = f"certificates/{cid_base64}.cert"
